...
HttpConnection.prototype.write = function(data) {
  ...
  if (this.client.extraParams && this.client.extraParams.extraHeaders) {
    for (var param in this.client.extraParams.extraHeaders) {
      opts.headers[param] = this.client.extraParams.extraHeaders[param];
    }
    delete this.client.extraParams;
  }
  var req = (self.https) ?
